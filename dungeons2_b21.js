...
var LaunchDungeons=function()
{
	...
	*/
	...
	new Game.Monster('Sentient Furnace II','sentientFurnace',[2,3],0,{hp:220,might:20,guard:24,speed:8,dodge:0,rarity:1.2},bossLoot);//boss
	...
	new Game.Monster('Ascended Baking Pod II','ascendedBakingPod',[3,3],0,{hp:220,might:18,guard:30,speed:7,dodge:0,rarity:0.7},bossLoot);//boss
