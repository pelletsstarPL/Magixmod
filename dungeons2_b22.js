...
var LaunchDungeons=function()
{
	...
	*/
	...
	Game.Monsters['Sentient Furnace'].onKill=function(){Game.Win('Getting even with the oven');};Game.Monsters['Sentient Furnace'].AI='static';Game.Monsters['Sentient Furnace II'].boss=1.2;Game.Monsters['Sentient Furnace II'].quotes={fight:'YOU ARE NOT READY! I AM WAY STRONGER NOW!',defeat:'OH... BURN.'};
	...
	Game.Monsters['Ascended Baking Pod'].onKill=function(){Game.Win('Now this is pod-smashing');};Game.Monsters['Ascended Baking Pod'].AI='static';Game.Monsters['Ascended Baking Pod II'].boss=1.2;Game.Monsters['Ascended Baking Pod II'].quotes={fight:'rrrrrrrise. Now I am STRONGER!',defeat:'blrglblg. fussssss'};
