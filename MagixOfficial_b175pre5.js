...
//New types of people
		...
		tick:function(me,tick)
		{
			var n=randomFloor(G.getRes('adult').amount*0.009,('Wine').amount*0.009);G.gain('drunk',n,'alcohol drinking');G.lose('adult',n,'alcohol drinking');G.lose('Wine',n,'drinking');
